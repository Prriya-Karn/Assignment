...
const Section2 = () => {
  return (
   <Fragment>
   <div className='main-section2 flex lg:flex-row flex-col justify-center 
    lg:mt-48 mt-20 2xl:ml-44 2xl:mr-44 xl:ml-7 xl:mr-7 lg:ml-10 lg:mr-10 sm:ml-10 w-full lg:gap-0 sm:gap-20 gap-10'>

   <div className='left-content w-full xl:w-1/2 xl:ml-10 2xl:ml-0  lg:w-3/4'>
   <div className='sub-content  p-10 -mt-10'>
   <p className='font-semibold text-lg sm:text-2xl sm:w-5/6 lg:w-3/4'>Company newsletters are essential in building
